  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-[1fr_2fr] gap-2 grid-flow-dense">
        {/* profile */}
        <section className="card profile col-span-1 row-span-4" aria-label="사용자 프로필">
          <h2 className="bg-white">프로필</h2>
          {/* profile-image-wrapper */}
          <div className="profile-image-wrapper">
            <img src="image/profile_img.jpg" alt="프로필 사진" />
            <p>이민제(LEE MINJE)</p>
          </div>
          {/* content */}
        ...
        {/* introduce */}
        <section className="card introduce col-span-1 row-span-3">
          <h2>
          ...
          <div className="content">
            <div className="info">
              <div className="quote_box">
                ...
                <span className="hashtag">#탐구하는_자세 #노력 #성장</span>
                <div className="hashtag_hover">
              ...
              <div className="grass-activity">
                <img src="https://ghchart.rshah.org/olminje" alt="깃허브 활동 히트맵" />
                <p className="grass-comment">잔디... 열심히 채워볼게요.</p>
              </div>
            </div>
            <hr />
        ...
        {/* career */}
        <section className="card career col-span-1 row-span-2">
          <h2>
            <i className="fa-solid fa-briefcase" />
            Work Experience
          </h2>
        ...
        {/* education */}
        <section className="card education col-span-1 row-span-1">
          <h2>
          ...
          <div className="content">
            <div className="info">
              ...
              <div>
                <h4 className="period">
                  <i className="fa-solid fa-calendar-days" />
                  Jun. 2025 - <span className="period_current">Current</span>
                </h4>
                <p>프론트엔드개발자 과정</p>
              </div>
            </div>
